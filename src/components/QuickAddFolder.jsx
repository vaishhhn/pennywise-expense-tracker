...
import { PlusCircle, Sparkles, Check, Tag } from 'lucide-react';
import confetti from 'canvas-confetti';

const QUICK_AMOUNTS = [50, 100, 200, 500, 1000, 2000];

export const QuickAddFolder = () => {
    ...
    <div className="bg-[#FFF8F3] rounded-3xl p-6 sm:p-7 border-2 border-[#FAD4BD] shadow-cute">
      ...
      <div className="flex items-center justify-between pb-4 mb-5 border-b border-[#FAD4BD]">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-black text-[#452632] font-display flex items-center gap-1.5">
              <span>Quick Add Expense</span>
              <Sparkles className="w-4 h-4 text-[#91204D]" />
            </h3>
            <p className="text-xs font-semibold text-[#75475E]">
              Log milk, groceries, bills, or rent in seconds
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2 bg-[#FFFDFB] border-2 border-[#FAD4BD] focus:border-[#91204D] rounded-2xl text-xs font-bold text-[#452632] focus:outline-none"
            />
          </div>
